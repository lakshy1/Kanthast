...
const Navbar = () => {
  ...
  return (
    <nav className="w-full sticky top-0 z-50 bg-gradient-to-r from-[#060c16] via-[#0a1530] to-[#07101e] backdrop-blur-md border-b border-white/10">
      ...
      <AnimatePresence>
        {isMobileOpen && (
          <motion.div
            ...
            transition={{ duration: 0.3 }}
            className="md:hidden bg-[#07101e] px-6 pb-6 flex flex-col gap-6"
          >
